...
@inject("AppState")
@observer
class DeploymentDetailAdmin extends Component {
...
*/
  ...
  render() {
    ...
    return (
      <div>
        <PageHeader title={HAP.languageChange("deployment.detail")} backPath="/iam/deploymentAdmin">
        </PageHeader>
...
export default Form.create({})(withRouter(DeploymentDetailAdmin));
