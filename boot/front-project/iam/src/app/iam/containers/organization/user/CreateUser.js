...
class CreateUser extends Component{
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        const {CreateUserStore} = this.props;
        CreateUserStore.createUser(data,data.organizationId).then(data=>{
  ...
  render() {
    ...
    return (
      <div>
        <PageHeader title={HAP.languageChange("user.create")} backPath="/iam/user"/>
...
export default Form.create({})(withRouter(CreateUser));
